...
# path
_C.MODEL.WEIGHT = "catalog://ImageNetPretrained/MSRA/R-101"# @absolute path
...
_C.MODEL.RETINANET.ASPECT_RATIOS = (0.5, 0.75, 1.0, 1.25, 1.5,2.0)
...
_C.MODEL.RETINANET.NUM_CONVS = 5
...
# Misc options
# ---------------------------------------------------------------------------- #
_C.OUTPUT_DIR = "/srv/home/yliu/maskrcnn-benchmark/output"
